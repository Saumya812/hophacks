...
import CaseActivityRow from "./case_activity_table";

/** Type-only namespace exports for generated type groups. */

/** The schema information for all tables in this module. This is defined the same was as the tables would have been defined in the server. */
const tablesSchema = __schema({
  caseActivity: __table({
    name: 'case_activity',
    indexes: [
      { accessor: 'id', name: 'case_activity_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'person_id', name: 'case_activity_person_id_idx_btree', algorithm: 'btree', columns: [
        'personId',
      ] },
    ],
    constraints: [
      { name: 'case_activity_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, CaseActivityRow),
});
...
const proceduresSchema = __procedures(
  __procedureSchema("execute_query", ExecuteQueryProcedure.params, ExecuteQueryProcedure.returnType),
);

type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `caseActivity` instead. This alias will be removed in the next major version. */
    readonly "case_activity": Omit<typeof tablesSchema.schemaType.tables["caseActivity"], "accessorName"> & { readonly accessorName: "case_activity" };
  };
};
...
export type DbView = __DbViewBase & {
  /** @deprecated Use `caseActivity` instead. This alias will be removed in the next major version. */
  readonly "case_activity": __DbViewBase["caseActivity"];
};

type __TablesBase = __QueryBuilder<typeof tablesSchema.schemaType>;
export type Tables = __TablesBase & {
  /** @deprecated Use `caseActivity` instead. This alias will be removed in the next major version. */
  readonly "case_activity": __TablesBase["caseActivity"];
};
