"""Add Jemi as a reunited (found) demo case with the provided photo."""
...
SRC = Path(
    ...
    r"\c__Users_User_AppData_Roaming_Cursor_User_workspaceStorage_ecbe86187d29129beb28394ce5d11b10_images_image-8e854b8b-2073-4d90-b2eb-c51e31c0c792.png"
)
...
def main() -> None:
    ...
    out = ROOT / "frontend" / "public" / "case-photos" / "jemi.jpg"
    ...
    existing = next(
        (p for p in people if (p.get("name") or "").strip().lower().startswith("jemi")),
        None,
    )
    ...
    row = {
        ...
        "age": 19,
        "gender": "female",
        "last_seen_location": "Ednor Gardens-Lakeside, Baltimore, MD",
        "last_seen_date": "2026-09-08",
        "description": (
            "Demo reunited case. Approx 5'5\", long dark wavy hair, last seen near "
            "Ednor Gardens-Lakeside wearing a black top. "
        ...
        "found_at": now,
        "found_date": now,
        "found_message": "Found safe in Ednor Gardens-Lakeside. Reunited with family.",
        "found_notes": "Located in Ednor Gardens-Lakeside; marked found for demo.",
        "verified_by": "law_enforcement",
        "external_case_number": "DEMO-FOUND-JEMI",
